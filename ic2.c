...
//global defines
#define ICxMD		PMD2bits.IC2MD
#define ICxCON		IC2CON
#define ICxIF		IFS0bits.IC2IF
#define ICxIE		IEC0bits.IC2IE
#define ICxIP		IPC1bits.IC2IP
...
//input capture ISR
void _ISR _IC2Interrupt(void) {			//for PIC24
	//clear the flag
