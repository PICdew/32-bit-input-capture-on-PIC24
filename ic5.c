...
//global defines
#define ICxMD		PMD2bits.IC5MD
#define ICxCON		IC5CON
#define ICxIF		IFS2bits.IC5IF
#define ICxIE		IEC2bits.IC5IE
#define ICxIP		IPC9bits.IC5IP
...
//input capture ISR
void _ISR _IC5Interrupt(void) {			//for PIC24
	//clear the flag
