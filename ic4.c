...
//global defines
#define ICxMD		PMD2bits.IC4MD
#define ICxCON		IC4CON
#define ICxIF		IFS2bits.IC4IF
#define ICxIE		IEC2bits.IC4IE
#define ICxIP		IPC9bits.IC4IP
...
//input capture ISR
void _ISR _IC4Interrupt(void) {			//for PIC24
	//clear the flag
...
void ic4_init(void) {
	...
	ICxCON  = 	//(0<<15) |				//1->enable the module, 0->disable the module
				...
				(0<<7) |				//1->timer2 as timebase, 0->timer3 as timebase
